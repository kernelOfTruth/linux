...
static void steal_from_bitmap_to_front(struct btrfs_free_space_ctl *ctl,
				       struct btrfs_free_space *info,
				       bool update_stat)
{
	struct btrfs_free_space *bitmap;
			      ...
			      bool update_stat)
{
	...
	if (ctl->total_bitmaps > 0) {
		steal_from_bitmap_to_end(ctl, info, update_stat);
		if (ctl->total_bitmaps > 0)
			steal_from_bitmap_to_front(ctl, info, update_stat);
	}
}
